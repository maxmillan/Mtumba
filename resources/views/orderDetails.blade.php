    ...
    <div class="row">
        ...
        <section class="content">
            ...
            <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="table-container">
                            <table class="table table-filter">
                                ...
                                @foreach($orderDetails as $orderDetail)
                                    ...
                                    <td>
                                        <div class="media">
                                            <a href="{{url('confirmation',$orderDetail->id)}}" class="pull-left">
                                                <img src="https://s3.amazonaws.com/uifaces/faces/twitter/fffabs/128.jpg" class="media-photo">
                                            </a>
                                            <a href="{{url('confirmation',$orderDetail->id)}}">
                                            <div class="media-body">
                                                <span class="media-meta pull-right">{{$orderDetail->created_at}}</span>
                                                <h4 class="title">
                                                    Order Id #{{$orderDetail->id}}
                                                    <span class="pull-right pagado">(completed)</span>
                                                </h4>
                                                <p class="summary">{{$orderDetail->picture_desc}}</p>
                                            </div>
                                            </a>
                                        </div>
                                    </td>
                ...
                <a href="{{url('/')}}"><button class="btn btn-success">RETURN HOME</button></a>
